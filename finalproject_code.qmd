...
saveRDS(final_xgb_fit, "../output/final_xgb_fit.rds")
saveRDS(final_train, "../output/final_train_reference.rds")
...
```{r}
saveRDS(xgb_pred_2023, "../output/xgb_pred_2023.rds")
saveRDS(xgb_metrics, "../output/xgb_metrics.rds")
```
